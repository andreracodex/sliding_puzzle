...
class Board(Frame):
        ...
        for i in range(self.N):
            for j in range(self.N):
                ...
                if tmp == self.Nsq:
                    ...
                    if self.N == 3 :
                        tmp_image = Image.open(f"3/{tmp}.png")  # Replace with the path to your tile images
                    else :
    ...
    def create_content(self):
        ...
        solve_status = Label(frame0, text="Apakah puzzle sudah terselesaikan?")
        ...
        moves_msg = Label(frame0,text="Bergeser sebanyak")
        ...
        but_back = Button(frame2, text="Kembali", bg="orange", justify="center", font=("Arial Bold", 10),command=self.goToStart)
        ...
        txt2start = "Selamat datang di Image Puzzle game.\n"+\
            "Berikut langkah-langkahnya untuk otomatis:\n"+\
            "1. Tekan tombol Acak, agar setiap bagian dari gambar diacak.\n\n"+\
            "2. Lalu tekan tombol Analisa,\n"+\
                "agar sistem menganalisa solusi penyelesaian puzzle menggunakan A*,\n"+\
                "akan membutuhkan berapa langkah. \n\n"+\
            "3. Setelah itu tekan tombol Solusi, maka sistem akan menjalankan pergerakan otomatis untuk menyelesaikan puzzle, sesuai dengan gambar aslinya.\n\n"+\
            "Atau dengan memainkan game secara cara manual:\n"+\
            "Dengan cara anda menggeser bagian gambar ke bagian yang kosong,\n"+\
                "hingga menemukan solusi puzzle sesuai dengan gambar semula. Good Luck\n\n\n"
